...
function CartProducts(props) {
	return (
		<section className="modal fade" id="product-preview" tabIndex={-1} role="dialog" aria-hidden="true">
			<div className="modal-dialog modal-lg product-modal">
				<div className="modal-content">
					<Link aria-hidden="true" data-dismiss="modal" className="sb-close-btn close" href="#">
						{' '}
							...
							<div className="product-content block-inline">
								...
								<div className="single-caption">
									...
									<div className="fsz-16">
										<p>
											Lorem ipsum dolor sit amet, consectetuer adiping elit food sed diam nonummy
